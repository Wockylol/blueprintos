    ...
    <div className="min-h-screen bg-gradient-luxury">
      <nav className="bg-white/80 dark:bg-dark-900/80 backdrop-blur-xl border-b border-light-300 dark:border-dark-700">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <ThemeToggle />
            <button className="p-2 hover:bg-light-300 dark:hover:bg-dark-800 rounded-lg transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Continue your transformation journey</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="card-glass">
            ...
            <div className="text-4xl font-bold text-gray-900 dark:text-white mb-1">{progressPercentage}%</div>
            <div className="text-sm text-gray-500 dark:text-gray-500">Completion rate</div>
          </div>
          ...
          <div className="card-glass">
            ...
            <div className="text-4xl font-bold text-gray-900 dark:text-white mb-1">{stats.upcomingSessions}</div>
            <div className="text-sm text-gray-500 dark:text-gray-500">Coming up</div>
          </div>
          ...
          <div className="card-glass">
            ...
            <div className="text-4xl font-bold text-gray-900 dark:text-white mb-1">{stats.streak}</div>
            <div className="text-sm text-gray-500 dark:text-gray-500">Days active</div>
          </div>
        </div>
