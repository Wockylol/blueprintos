...
export function LandingPage({ onGetStarted }: { onGetStarted: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-luxury">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center animate-fade-in">
            <div className="inline-block mb-6 px-6 py-2 bg-primary-500/10 border border-primary-500/20 rounded-full">
              <span className="text-primary-600 dark:text-primary-400 font-semibold">White-Label Coaching Platform</span>
            </div>
            <h1 className="mb-6">
              <span className="block text-gray-900 dark:text-white">Launch Your Own</span>
              <span className="block gradient-text">Coaching Platform in Minutes</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-400 mb-12 max-w-3xl mx-auto" style={{ lineHeight: '1.5' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <div className="card-glass text-center animate-slide-up" style={{ animationDelay: '0.1s' }}>
                ...
                <div className="text-gray-600 dark:text-gray-400">Revenue Processed</div>
              </div>
              <div className="card-glass text-center animate-slide-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="text-gray-600 dark:text-gray-400">Active Coaches</div>
              </div>
      ...
      <section id="features" className="py-20 px-6 bg-light-200/50 dark:bg-dark-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="mb-4 text-gray-900 dark:text-white">Why BlueprintOS?</h2>
            <p className="text-xl text-gray-700 dark:text-gray-400">The only platform built for coaches who want to scale</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card-glass text-center hover:shadow-glow-blue transition-all duration-300">
              ...
              <h3 className="text-2xl mb-4 text-gray-900 dark:text-white">Your Branded Workspace</h3>
              <p className="text-gray-700 dark:text-gray-400" style={{ lineHeight: '1.5' }}>
            ...
            <div className="card-glass text-center hover:shadow-glow-violet transition-all duration-300">
              ...
              <h3 className="text-2xl mb-4 text-gray-900 dark:text-white">Built-In Client Tracking</h3>
              <p className="text-gray-700 dark:text-gray-400" style={{ lineHeight: '1.5' }}>
            ...
            <div className="card-glass text-center hover:shadow-glow-blue transition-all duration-300">
              ...
              <h3 className="text-2xl mb-4 text-gray-900 dark:text-white">Payments Built-In</h3>
              <p className="text-gray-700 dark:text-gray-400" style={{ lineHeight: '1.5' }}>
      ...
      {testimonials.length > 0 && (
        <section id="testimonials" className="py-20 px-6">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="mb-4 text-gray-900 dark:text-white">Coaches Love BlueprintOS</h2>
              <p className="text-xl text-gray-700 dark:text-gray-400">Join hundreds of coaches growing their businesses</p>
            </div>
            <div className="relative">
              <div className="card-glass max-w-3xl mx-auto">
                <Quote className="w-12 h-12 text-primary-500/30 mb-6" />
                <p className="text-xl text-gray-700 dark:text-gray-300 mb-6" style={{ lineHeight: '1.5' }}>
      ...
      <section id="pricing" className="py-20 px-6 bg-light-200/50 dark:bg-dark-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="mb-4 text-gray-900 dark:text-white">Simple, Transparent Pricing</h2>
            <p className="text-xl text-gray-700 dark:text-gray-400">Choose the plan that fits your coaching business</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="card-glass hover:scale-105 transition-all duration-300">
              <div className="text-sm text-primary-600 dark:text-primary-400 font-semibold mb-2">STARTER</div>
              <div className="text-4xl font-bold text-gray-900 dark:text-white mb-4">$97</div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Up to 10 clients</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-primary-500 rounded-full flex items-center justify-center mt-0.5">
                    <span className="text-xs text-white">✓</span>
                  </div>
                  <span className="text-gray-700 dark:text-gray-300">Branded subdomain</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-primary-500 rounded-full flex items-center justify-center mt-0.5">
                    <span className="text-xs text-white">✓</span>
                  </div>
                  <span className="text-gray-700 dark:text-gray-300">Client dashboards</span>
                </li>
              </ul>
            ...
            <div className="card-glass hover:scale-105 transition-all duration-300 border-2 border-primary-500 relative">
              ...
              <div className="text-sm text-primary-600 dark:text-primary-400 font-semibold mb-2">PRO</div>
              <div className="text-4xl font-bold text-gray-900 dark:text-white mb-4">$197</div>
              <div className="text-gray-600 dark:text-gray-400 mb-6">per month</div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-primary-500 rounded-full flex items-center justify-center mt-0.5">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Up to 50 clients</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-primary-500 rounded-full flex items-center justify-center mt-0.5">
                    <span className="text-xs text-white">✓</span>
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">AI landing page builder</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-primary-500 rounded-full flex items-center justify-center mt-0.5">
                    <span className="text-xs text-white">✓</span>
            ...
            <div className="card-glass hover:scale-105 transition-all duration-300">
              <div className="text-sm text-primary-600 dark:text-primary-400 font-semibold mb-2">ENTERPRISE</div>
              <div className="text-4xl font-bold text-gray-900 dark:text-white mb-4">$497</div>
              <div className="text-gray-600 dark:text-gray-400 mb-6">per month</div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-primary-500 rounded-full flex items-center justify-center mt-0.5">
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Team member access</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-primary-500 rounded-full flex items-center justify-center mt-0.5">
                    <span className="text-xs text-white">✓</span>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="mb-6 text-gray-900 dark:text-white">Ready to Scale Your Coaching Business?</h2>
          <p className="text-xl text-gray-700 dark:text-gray-400 mb-8" style={{ lineHeight: '1.5' }}>
      ...
      <footer className="border-t border-light-300 dark:border-dark-700 py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">Features</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">Pricing</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">Integrations</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-white mb-4">Company</h4>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">About</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">Contact</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">Blog</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-white mb-4">Legal</h4>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">Privacy</a></li>
                <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">Terms</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-light-300 dark:border-dark-700 mt-12 pt-8 text-center text-gray-600 dark:text-gray-400">
